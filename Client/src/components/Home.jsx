...
const Home = () => {
  ...
  const { recipe, savedRecipeById, isAuthenticated, loading } = useContext(AppContext);
  ...
  return (
    <>
      ...
      <div className="container">
        {loading ? (
          <p className="text-center text-light">Recipes are loading from the database, please wait...</p>
        ) : (
          <div className="row">
            {recipe.map((data) => (
